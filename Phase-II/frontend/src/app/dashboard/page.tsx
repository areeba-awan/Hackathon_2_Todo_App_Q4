        ...
        <div className="max-w-7xl mx-auto">
          ...
          <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <AnimatedDiv direction="down" delay={0.1}>
              <h1 className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">Dashboard</h1>
              <p className="text-indigo-800 dark:text-indigo-400 text-lg font-medium">Manage your tasks efficiently</p>
            </AnimatedDiv>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { title: 'Total Tasks', value: stats.total, color: 'from-purple-500 to-pink-500', icon: '📋' },
              { title: 'Completed', value: stats.completed, color: 'from-green-500 to-emerald-500', icon: '✅' },
              { title: 'Active', value: stats.active, color: 'from-blue-500 to-cyan-500', icon: '🔄' },
              { title: 'High Priority', value: stats.highPriority, color: 'from-red-500 to-orange-500', icon: '❗' },
            ].map((stat, index) => (
              <AnimatedDiv key={stat.title} direction="up" delay={0.1 * index}>
                <Card className="bg-gradient-to-b from-white to-purple-50/50 dark:from-gray-800/50 dark:to-purple-900/20 border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <CardContent className="p-6 flex items-center">
                    <div className={`text-5xl mr-4 bg-clip-text text-transparent bg-gradient-to-r ${stat.color}`}>{stat.icon}</div>
                    <div>
                      <div className={`text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r ${stat.color}`}>{stat.value}</div>
                      <div className="text-indigo-900 dark:text-indigo-300 text-lg font-medium">{stat.title}</div>
                    </div>
                  </CardContent>
                </Card>
              </AnimatedDiv>
